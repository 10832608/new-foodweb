<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dld.aspx.cs" Inherits="FOODWEB.home" %>
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/chicken.jpg" alt=""/>
              ...
              <div class="down-content">
                <h4><font color="black">嘉義縣大林鎮中興路40號</font></h4>
          ...
          <div class="col-md-6">
           <iframe src="https://www.google.com/maps/embed?pb=!4v1655372417037!6m8!1m7!1s1AcMOTl8m6SotoB0IMC2xA!2m2!1d23.6039696123466!2d120.4552438396665!3f211.49208862088076!4f-11.003820438786875!5f0.7820865974627469" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> </div>
      </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
     ...
     <FooterStyle CssClass="GridViewFooterStyle" />
                ...
                <HeaderStyle CssClass="GridViewHeaderStyle" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [dld]"></asp:SqlDataSource>
