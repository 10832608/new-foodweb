<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mxd.aspx.cs" Inherits="FOODWEB.home" %>
      ...
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/Bigplate.jpg" alt=""/>
               
              <div class="down-content">
                <h4><font color="black">嘉義縣民雄鄉昇平路17-2號</font></h4>
          ...
          <div class="col-md-6">
           <iframe src="https://www.google.com/maps/embed?pb=!4v1655374760210!6m8!1m7!1sz9l2_Tedi8d4Hb6S6rS7oQ!2m2!1d23.55697335050382!2d120.4299988678896!3f262.7667289307015!4f-1.573123011923002!5f0.7820865974627469" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="datatime" HeaderText="發言時間" SortExpression="datatime" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [mxd]"></asp:SqlDataSource>
