<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CHC.aspx.cs" Inherits="FOODWEB.home" %>
      ...
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/1fan.jpg" alt=""/>
               
              <div class="down-content">
                <h4><font color="black">嘉義縣民雄鄉神農一街3號</font></h4>
          ...
          <div class="col-md-6">
            <iframe src="https://www.google.com/maps/embed?pb=!4v1655364856452!6m8!1m7!1stTmIkf1-iGi2r7-6KugA7Q!2m2!1d23.55677096546293!2d120.4720389610457!3f125.67890617867978!4f-3.141738789740401!5f1.6941030682084808" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
            </div>
      </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
     ...
     <FooterStyle CssClass="GridViewFooterStyle" />
                ...
                <HeaderStyle CssClass="GridViewHeaderStyle" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [chc]"></asp:SqlDataSource>
