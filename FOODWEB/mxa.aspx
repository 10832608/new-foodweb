<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mxa.aspx.cs" Inherits="FOODWEB.home" %>
      ...
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/firechickenrice.jpg" alt=""/>
             
              <div class="down-content">
                <h4><font color="black"> 嘉義縣民雄鄉民權路6號</font></h4>
          ...
          <div class="col-md-6">
            <iframe src="https://www.google.com/maps/embed?pb=!4v1655373845350!6m8!1m7!1sAyNbZC-p9SCcmNg2QqN5Mw!2m2!1d23.55828314498675!2d120.4303344322108!3f63.42719866696625!4f-2.2449142095859855!5f0.7820865974627469" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="datatime" HeaderText="發言時間" SortExpression="datatime" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [mxa]"></asp:SqlDataSource>
