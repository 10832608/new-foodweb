<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CHF.aspx.cs" Inherits="FOODWEB.home" %>
      ...
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/Abao.jpg" alt=""/>
               
              <div class="down-content">
                <h4><font color="black">嘉義縣民雄鄉裕農路189號</font></h4>
          ...
          <div class="col-md-6">
           <iframe src="https://www.google.com/maps/embed?pb=!4v1655368943544!6m8!1m7!1s3hU1IPDeDm7v2sS-Aas5ug!2m2!1d23.55802841315903!2d120.4699565211542!3f278.06730405948355!4f5.804510441892802!5f0.7820865974627469" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> </div>
            </div>
      </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
     ...
     <FooterStyle CssClass="GridViewFooterStyle" />
                ...
                <HeaderStyle CssClass="GridViewHeaderStyle" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [chf]"></asp:SqlDataSource>
