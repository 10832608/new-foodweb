<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mxe.aspx.cs" Inherits="FOODWEB.home" %>
      ...
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/fusan.jpg" alt=""/>
                
              <div class="down-content">
                <h4><font color="black">嘉義縣民雄鄉文化路60-5號</font></h4>
          ...
          <div class="col-md-6">
           <iframe src="https://www.google.com/maps/embed?pb=!4v1655375156976!6m8!1m7!1sNAfETVcpPG3eC3N14_X5wg!2m2!1d23.55446654008764!2d120.4299326692186!3f110.52833931458359!4f8.79381706938537!5f0.7820865974627469" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> 
        </div>
      </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="datatime" HeaderText="發言時間" SortExpression="datatime" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [mxe]"></asp:SqlDataSource>
