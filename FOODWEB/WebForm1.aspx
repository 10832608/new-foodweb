<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="FOODWEB.WebForm1" %>
      ...
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-4">
          ...
          <div class="col-md-6">
            <<iframe src="https://www.google.com/maps/embed?pb=!4v1651048602354!6m8!1m7!1sjbWpa5-s9XUFN2Ade-bShQ!2m2!1d23.5588930828616!2d120.4686657342113!3f131.27461849502026!4f-7.095230525899552!5f0.7820865974627469" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1"
            ...
            <AlternatingRowStyle CssClass="AltRowStyle" />
                    ...
                    <br />
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [評論區]"></asp:SqlDataSource>
