<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CHD.aspx.cs" Inherits="FOODWEB.home" %>
        ...
        <div class="row">
         ...
         <div class="col-md-4">
            <div class="product-item">
                <img src="assets/images/kuosao.jpg" />
           <img src="assets/images/chd1.jpg" alt=""/>
               
              <div class="down-content">
                <h4><font color="black"> 嘉義縣民雄鄉富農路117附2號</font></h4>
          ...
          <div class="col-md-6">
            <iframe src="https://www.google.com/maps/embed?pb=!4v1655368169168!6m8!1m7!1sCFcD4O0dMBDkNeVm-_SDoA!2m2!1d23.55730626753949!2d120.4734086335151!3f253.71867149779254!4f5.9989301191811535!5f1.5394401703008422" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
            </div>
      </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
     ...
     <FooterStyle CssClass="GridViewFooterStyle" />
                ...
                <HeaderStyle CssClass="GridViewHeaderStyle" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [chd]"></asp:SqlDataSource>
