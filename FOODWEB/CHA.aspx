<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CHA.aspx.cs" Inherits="FOODWEB.home" %>
        ...
        <div class="row">
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/a-1.jpg" alt=""/>
                <img src="assets/images/cha1.jpg" />
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="datatime" HeaderText="發言時間" SortExpression="datatime" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [cha]"></asp:SqlDataSource>
