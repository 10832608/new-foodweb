<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mxf.aspx.cs" Inherits="FOODWEB.home" %>
      ...
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/tunjiangraman.jpg" alt=""/>
                
              <div class="down-content">
                <h4><font color="black">嘉義縣民雄鄉安和路86-1號</font></h4>
...
17:00–20:30</p>
                  <p>
                      星期日<br />11:00–14:00<br />17:00–21:00
                  </p>
                <ul class="stars">
          ...
          <div class="col-md-6">
           <iframe src="https://www.google.com/maps/embed?pb=!4v1655375563786!6m8!1m7!1s_qLL3NT2NnWg60sJ_eyI-Q!2m2!1d23.55513970845016!2d120.4258758478222!3f304.8105465813525!4f-0.25995469649063807!5f0.7820865974627469" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="datatime" HeaderText="發言時間" SortExpression="datatime" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [mxf]"></asp:SqlDataSource>
