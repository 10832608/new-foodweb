<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dla.aspx.cs" Inherits="FOODWEB.home" %>
      ...
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/dla.jpg" alt=""/>
               
              <div class="down-content">
                <h4><font color="black">嘉義縣大林鎮中山路114號</font></h4>
          ...
          <div class="col-md-6">
          <iframe src="https://www.google.com/maps/embed?pb=!4v1655369858388!6m8!1m7!1sWrrIylpzCRz6ZeSTKDU5yg!2m2!1d23.60377189563895!2d120.4553280439905!3f120.32580885967855!4f3.127520154383717!5f0.4000000000000002" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> </div>
      </div>
          </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
     ...
     <FooterStyle CssClass="GridViewFooterStyle" />
                ...
                <HeaderStyle CssClass="GridViewHeaderStyle" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [dla]"></asp:SqlDataSource>
