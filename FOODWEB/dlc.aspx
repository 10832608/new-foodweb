<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dlc.aspx.cs" Inherits="FOODWEB.home" %>
      ...
      <div class="container">
        <div class="row">
         ...
         <div class="col-md-4">
           ...
           <img src="assets/images/duckrice.jpg" alt=""/>
               
              <div class="down-content">
                <h4><font color="black">622嘉義縣大林鎮新興街155號</font></h4>
          ...
          <div class="col-md-6">
          <iframe src="https://www.google.com/maps/embed?pb=!4v1655372116789!6m8!1m7!1sLafwxIUMge2Y12hteew9sA!2m2!1d23.59804665667154!2d120.458442774159!3f105.11886213470962!4f4.0171088034676785!5f1.5378273236790698" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> </div>
      </div>
          </div>
    </div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="number" DataSourceID="SqlDataSource1">
     ...
     <FooterStyle CssClass="GridViewFooterStyle" />
                ...
                <HeaderStyle CssClass="GridViewHeaderStyle" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:評論區ConnectionString %>" SelectCommand="SELECT * FROM [dlc]"></asp:SqlDataSource>
