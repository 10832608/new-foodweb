...
namespace FOODWEB
{
    public partial class home : System.Web.UI.Page
    {
        ...
        protected void postbtn1_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand command = new SqlCommand("INSERT INTO [評論區].[dbo].[dlf] ([title],[name],[message],[datatime]) VALUES(@title,@name,@message,@datatime)", connection))
                {
                    //賦予參數資料型態與值
